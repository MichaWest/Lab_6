...
import ru.itmo.michawest.lab6.data.*;
import ru.itmo.michawest.lab6.exceptions.EmptyStringException;
import ru.itmo.michawest.lab6.exceptions.InvalidEnumException;
import ru.itmo.michawest.lab6.exceptions.InvalidNumberException;
import ru.itmo.michawest.lab6.exceptions.ParameterException;
...
public class ConsoleInput extends InputAll {
    ...
    public Person readPerson() throws ParameterException {
        ...
        LocalTime createTime = readCreateTime();
    ...
    @Override
    public LocalTime readCreateTime() {
